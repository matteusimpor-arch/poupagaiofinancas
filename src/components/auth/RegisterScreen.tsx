      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl border border-[#DDE8E0] p-7 md:p-8 space-y-6">
        <div className="flex flex-col items-center text-center space-y-2">
          ...
          <p className="text-xs text-[#68736C] max-w-xs">
            Comece a organizar suas finanças com simplicidade e liberdade
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            <span>{isLoading ? 'Cadastrando...' : 'Criar Minha Conta Gratuita'}</span>
            <ArrowRight size={17} />
          </button>
          ...
          >
            ...
            <span>{isGoogleLoading ? 'Conectando...' : 'Cadastrar com Google (Firebase)'}</span>
          </button>
        </form>

        {/* Link para Login */}
        <div className="text-center pt-1 border-t border-[#DDE8E0]/70">
